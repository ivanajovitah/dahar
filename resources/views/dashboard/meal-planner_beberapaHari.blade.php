                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-7" style="padding: 0;">
                            <div class="btn-group" role="group" id="containerMovePeriode">
                                <a href="/planner-days/{{$lastWeek}}"><button type="button" class="btn btn-outline-info"><i class="fas fa-chevron-left"></i></button></a>
                                <a href="/planner-days"><button type="button" class="btn btn-outline-info">Ke Hari Ini</button></a>
                                <a href="/planner-days/{{$nextWeek}}"><button type="button" class="btn btn-outline-info" style="border-left: 0;"><i class="fas fa-chevron-right"></i></button></a>
                            </div>
                        </div>
                    </div>
                </div>
