...
<style>
    ...
    .grafDetailSection .textCOntainer .giziText.carbsText{
        color: #FCB524;
    }
    .grafDetailSection .textCOntainer .giziText.fatText{
        color: #52C0BC;
    }
                ...
                <div class="col-sm-6">
                    <div class="row">
                        <div class="col-sm-5" style="padding: 0;">
                            <div class="dropdown">
                                <button class="btn btn-outline-info dropdown-stoggle" type="button" id="periodeDropDown" data-bs-toggle="dropdown" aria-expanded="false">
                                Per Hari
                                <i class="fas fa-sort-down" style="float: right;"></i>
                                </button>
                                <ul class="dropdown-menu dropdown-menu" aria-labelledby="periodeDropDown">
                                    <li><a class="dropdown-item" href="/planner-week">Per Minggu</a></li>
                        ...
                        <div class="col-sm-7" style="padding: 0;">
                            <div class="btn-group" role="group" id="containerMovePeriode">
                                <a href="/planner-day/{{$lastWeek}}"><button type="button" class="btn btn-outline-info"><i class="fas fa-chevron-left"></i></button></a>
                                <a href="/planner-day"><button type="button" class="btn btn-outline-info">Ke Hari Ini</button></a>
                                <a href="/planner-day/{{$nextWeek}}"><button type="button" class="btn btn-outline-info" style="border-left: 0;"><i class="fas fa-chevron-right"></i></button></a>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="containerRecom">
                @foreach ($listGenerate as $date => $value)
                    @if($value['meta'] =='kosong')
                        <div class="row cardWeekly">
                                <div class="col-sm-6 containerTanggal">
                                    <h5><?php echo hari(str_replace("_","-",$date));?></h5>
                                </div>
                                <div class="col-sm-6"></div>
                                <div class="col-sm-6">
                                    <div class="row sectionMarign">
                                        <div class="col-sm-12 leftCardContainer">
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row cardWeekly">
                            ...
                            <div class="col-sm-6 containerRight">
                                <div class="row">  
                                    <div class="col-sm-12">
                                        <div class="row">
                                            <div class="col-sm-12 containerMenu containerBreakfast">
                                            ...
                                            <div class="col-sm-12 containerMenu containerLunch">
                                            ...
                                            <div class="col-sm-12 containerMenu containerDinner">
